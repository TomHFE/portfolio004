...
const P1 = new Project(
  ...
  ["/images/project-images/img-12.jpg", "/images/project-images/img-5.jpeg"],
...
const P2 = new Project(
  ...
  ["/images/project-images/img-8.jpg", "/images/project-images/img-7.jpg"],
...
const P3 = new Project(
  ...
  ["/images/project-images/img-10.jpg", "/images/project-images/img-9.jpg"],
...
const P4 = new Project(
  ...
  ["/images/project-images/img-11.jpg", "/images/project-images/img-6.jpg"],
...
const P5 = new Project(
  ...
  ["/images/project-images/img-1.jpeg", "/images/project-images/img-2.png"],
  [
    "React",
    "Javascript",
    "React Router",
...
const P6 = new Project(
  ...
  ["/images/project-images/img-13.jpg", "/images/project-images/img-14.jpg"],
  [
    "Vite",
    "React",
    "Typescript",
